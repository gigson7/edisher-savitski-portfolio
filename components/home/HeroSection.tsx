      ...
      <section className="relative h-[650px] lg:h-[750px] overflow-hidden">
        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 w-full">
            <div className="max-w-3xl pt-[100px] md:pt-[500px]">
              <p className="text-2xl sm:text-3xl text-gold-200 mb-10 lg:mb-10 font-light tracking-wide text-center lg:text-left">
